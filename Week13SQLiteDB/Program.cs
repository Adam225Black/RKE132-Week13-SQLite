...
static void ReadData(SQLiteConnection myConnection)
{
    ...
    //command.CommandText = "SELECT customer.firstName, customer.lastname, statustype " +
    //    "FROM customerStatus " +
...
static void DisplayProduct(SQLiteConnection myConnection)
{
    ...
    command.CommandText = "SELECT rowid, productName, productPrice FROM product";
...
static void DisplayProductWithCategory(SQLiteConnection myConnection)
{
    ...
    command.CommandText = "SELECT product.rowid, product.productName, ProductCategory.CategoryName " +
        "FROM product " +
        "JOIN ProductCategory ON ProductCategory.CategoryId = product.CategoryId";
